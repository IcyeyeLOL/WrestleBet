-- DEPLOY BETTING SYSTEM TO SUPABASE
-- Copy this entire script and run it in Supabase SQL Editor
-- This will create the bets table and triggers for real-time updates

BEGIN;

-- 1. Create bets table if it doesn't exist
...
-- 4. Create RLS policies for anonymous access
...
-- 6. Ensure matches table has the required columns
...
-- 7. Create function to automatically update match odds when bets change
...
-- 8. Create trigger to automatically update match odds
...
DROP FUNCTION IF EXISTS public.calculate_match_odds(UUID);
...
-- 10. Test query to verify everything works
SELECT 
    'Betting system deployed successfully!' as status,
...
-- 4. You should see "Betting system deployed successfully!" if it works
-- 5. Now your bets will automatically update match odds in real-time!
