-- Quick RLS Fix for Matches Table
...
-- Policy 3: Authenticated users can update matches
CREATE POLICY "Matches can be updated by admins" ON matches
    FOR UPDATE USING (auth.role() = 'authenticated');

-- Policy 4: Authenticated users can delete matches
...
-- Test query to verify matches are accessible
SELECT 
