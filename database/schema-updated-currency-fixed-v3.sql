-- UPDATED DATABASE SCHEMA FOR WRESTLEBET WITH WRESTLECOINS CURRENCY SYSTEM (FIXED VERSION 3)
-- Run this entire script in Supabase SQL editor
-- This version handles existing objects gracefully and fixes the ROUND function type issue
...
-- STEP 11: Create helpful views (FIXED - corrected ROUND function type casting)
