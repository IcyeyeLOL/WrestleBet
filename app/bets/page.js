...
// Lazy load the BetsPage component to prevent blocking navigation
const BetsPage = React.lazy(() => import('../components/BetsPage'));
...
const LoadingSpinner = () => (
  <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 flex items-center justify-center">
    <div className="text-center">
      ...
      <p className="text-yellow-400">Loading betting page...</p>
    </div>
  </div>
);

// Error boundary component
class BetsErrorBoundary extends React.Component {
  constructor(props) {
    super(props);
  ...
  componentDidCatch(error, errorInfo) {
    console.error('Bets page error:', error, errorInfo);
  }
            ...
            <div className="bg-white/10 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-white/20 max-w-md w-full text-center">
              <div className="mb-6">
                ...
                <p className="text-gray-300 text-lg leading-relaxed">
                  There was an error loading the betting page. Please try refreshing or contact support.
                </p>
              </div>
...
export default function Bets() {
        ...
        <div className="pt-20 flex items-center justify-center p-4">
          <div className="bg-white/10 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-white/20 max-w-md w-full text-center">
            <div className="mb-6">
              ...
              <p className="text-gray-300 text-lg leading-relaxed">
                Create an account to access your betting dashboard, place bets, and track your wins!
              </p>
            </div>
  ...
  // Render the betting page for authenticated users with error boundary
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800">
      <Navigation />
      <div className="pt-20">
