...
// Lazy load the DonationPage component to prevent blocking navigation
const DonationPage = React.lazy(() => import('../components/DonationPage'));
...
const LoadingSpinner = () => (
  <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 flex items-center justify-center">
    <div className="text-center">
      ...
      <p className="text-yellow-400">Loading donation page...</p>
    </div>
  </div>
);
...
class DonationErrorBoundary extends React.Component {
  ...
  componentDidCatch(error, errorInfo) {
    console.error('Donation page error:', error, errorInfo);
  }
            ...
            <div className="bg-white/10 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-white/20 max-w-md w-full text-center">
              <div className="mb-6">
                ...
                <p className="text-gray-300 text-lg leading-relaxed">
                  There was an error loading the donation page. Please try refreshing or contact support.
                </p>
              </div>
...
export default function Donation() {
  ...
  // Render the donation page for authenticated users with error boundary
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800">
      <Navigation />
      <div className="pt-20">
